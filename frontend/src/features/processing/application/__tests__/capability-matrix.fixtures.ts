  ...
  return {
    ...
    viewerMatrix: {
      ...
      formats: [
        ...
        viewerFormat('heic', ['heif'], 'HEIC', 'image', ['image/heic', 'image/heif'], 'server-assisted', 'heic-image', ['IMAGE_CONVERT']),
        viewerFormat('tiff', ['tif'], 'TIFF', 'image', ['image/tiff'], 'server-assisted', 'tiff-image', ['IMAGE_CONVERT']),
        viewerFormat('raw', ['dng', 'cr2', 'cr3', 'nef', 'arw', 'raf', 'rw2', 'orf', 'pef', 'srw'], 'RAW', 'image', [], 'server-assisted', 'raw-image', ['IMAGE_CONVERT']),
        viewerFormat('pdf', [], 'PDF', 'document', ['application/pdf'], 'server-assisted', 'pdf-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('txt', [], 'TXT', 'document', ['text/plain'], 'server-assisted', 'text-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('csv', [], 'CSV', 'document', ['text/csv'], 'server-assisted', 'csv-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('html', ['htm'], 'HTML', 'document', ['text/html'], 'server-assisted', 'html-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('rtf', [], 'RTF', 'document', ['application/rtf'], 'server-assisted', 'rtf-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('doc', [], 'DOC', 'document', ['application/msword'], 'server-assisted', 'doc-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('docx', [], 'DOCX', 'document', ['application/vnd.openxmlformats-officedocument.wordprocessingml.document'], 'server-assisted', 'docx-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('odt', [], 'ODT', 'document', ['application/vnd.oasis.opendocument.text'], 'server-assisted', 'odt-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('xls', [], 'XLS', 'document', ['application/vnd.ms-excel'], 'server-assisted', 'xls-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('xlsx', [], 'XLSX', 'document', ['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'], 'server-assisted', 'xlsx-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('pptx', [], 'PPTX', 'document', ['application/vnd.openxmlformats-officedocument.presentationml.presentation'], 'server-assisted', 'pptx-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('epub', [], 'EPUB', 'document', ['application/epub+zip'], 'server-assisted', 'epub-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('db', [], 'DB', 'document', ['application/octet-stream'], 'server-assisted', 'sqlite-document', ['DOCUMENT_PREVIEW']),
        viewerFormat('sqlite', [], 'SQLite', 'document', ['application/x-sqlite3'], 'server-assisted', 'sqlite-document', ['DOCUMENT_PREVIEW']),
        ...
        viewerFormat('avi', [], 'AVI', 'media', ['video/x-msvideo'], 'server-assisted', 'legacy-video', ['MEDIA_PREVIEW']),
        viewerFormat('mkv', [], 'MKV', 'media', ['video/x-matroska'], 'server-assisted', 'legacy-video', ['MEDIA_PREVIEW']),
        viewerFormat('wmv', [], 'WMV', 'media', ['video/x-ms-wmv'], 'server-assisted', 'legacy-video', ['MEDIA_PREVIEW']),
        viewerFormat('flv', [], 'FLV', 'media', ['video/x-flv'], 'server-assisted', 'legacy-video', ['MEDIA_PREVIEW']),
        ...
        viewerFormat('aac', [], 'AAC', 'audio', ['audio/aac'], 'server-assisted', 'legacy-audio', ['MEDIA_PREVIEW']),
        viewerFormat('flac', [], 'FLAC', 'audio', ['audio/flac'], 'server-assisted', 'legacy-audio', ['MEDIA_PREVIEW']),
        viewerFormat('aiff', ['aif'], 'AIFF', 'audio', ['audio/aiff'], 'server-assisted', 'legacy-audio', ['MEDIA_PREVIEW']),
      ],
    },
...
export function createConverterCapabilityScopeFixture(): ProcessingCapabilityScope {
  return {
    ...
    converterMatrix: {
      ...
      sourceFormats: [
        converterSource('jpg', ['jpeg'], 'JPG', 'native-raster', ['image/jpeg']),
        converterSource('png', [], 'PNG', 'native-raster', ['image/png']),
        converterSource('webp', [], 'WebP', 'native-raster', ['image/webp']),
        converterSource('bmp', [], 'BMP', 'native-raster', ['image/bmp']),
        converterSource('svg', [], 'SVG', 'native-raster', ['image/svg+xml']),
      ...
      scenarios: [
        ...
        converterScenario('png', 'jpg'),
        converterScenario('png', 'webp'),
        ...
        converterScenario('jpg', 'png'),
        converterScenario('jpg', 'webp'),
        converterScenario('jpg', 'avif', 'image', 'server-assisted'),
        converterScenario('jpg', 'tiff', 'image', 'server-assisted'),
        converterScenario('webp', 'jpg'),
        converterScenario('webp', 'png'),
        converterScenario('webp', 'tiff', 'image', 'server-assisted'),
        converterScenario('bmp', 'jpg'),
        converterScenario('bmp', 'png'),
...
function converterSource(
  ...
  return {
    ...
    mimeTypes,
    sourceStrategyId,
    statusLabel: sourceStrategyId === 'native-raster' ? 'Browser raster' : 'Server rasterization',
...
function converterTarget(
  ...
  return {
    ...
    defaultQuality,
    statusLabel: requiredJobTypes.length ? 'Server-assisted' : 'Browser-native',
...
function converterScenario(
  ...
  family = 'image',
  executionMode: 'browser-native' | 'server-assisted' = 'browser-native',
) {
  return {
